...
const Duration _kFadeInDuration = Duration(milliseconds: 32);
const Duration _kRadiusDuration = Duration(milliseconds: 200);
const Duration _kFadeOutDuration = Duration(milliseconds: 480);
const Duration _kCancelDuration = Duration(milliseconds: 480);
const double _kFadeOutIntervalStart = 280.0 / 480.0;
...
class HeronRipple extends InteractiveInkFeature {
  ...
  static const InteractiveInkFeatureFactory splashFactory = _HeronRippleFactory();
